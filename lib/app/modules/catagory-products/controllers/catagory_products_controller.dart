...
import 'package:edge_project/app/data/models/product_model.dart';
import 'package:get/get.dart';
import 'package:http/http.dart' as http;
class CatagoryProductsController extends GetxController {
  var isLoading = true.obs;
  var productList = <ProductModel>[].obs;
  var categoryName = Get.arguments;
  final allProductsUrl = "https://fakestoreapi.com/products/category/${Get.arguments.toString()}";
  ...
  void fetchProducts() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // Get.snackbar("ERROR", Get.arguments.toString());
      }
    } catch (e) {
      /// Show a toast message
